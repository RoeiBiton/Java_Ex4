...
public class Point2D{
	...
	//A function that "change" the scale of the point by moving it to the center by ratio
	public void scale(Point2D cen, double ratio) {
		//////////add your code below ///////////
		this._x=(this._x-cen.x())*ratio +cen.x();
		this._y=(this._y-cen.y())*ratio +cen.y();
		
		/////////////////////////////////////////
	}

	//A function that rotate the point by center axle and degrees
	public void rotate(Point2D cen, double angleDegrees) {
		//////////add your code below ///////////
		double angleInRadians = Math.toRadians(angleDegrees);
		double x1 = cen.x()+(_x-cen.x())*Math.cos(angleInRadians)-(_y-cen.y())*Math.sin(angleInRadians);
	    double y1= cen.y()+(_x-cen.x())*Math.sin(angleInRadians)+(_y-cen.y())*Math.cos(angleInRadians);
	    _x= x1;
	    _y =y1;
